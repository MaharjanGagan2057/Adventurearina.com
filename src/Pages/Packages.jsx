   ...
   {/* passing props on img */}
    ...
    <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
          ...
          <p classNameName="mb-3 font-normal text-gray-700 dark:text-gray-400 text-sm line-clamp-3">
            {props.description}
          </p>
        <div className="flex items-center justify-between">
          {/* passing price on props */}
            ...
            {/* booking btton */}
            <Link to='/Bookings' className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Book Now</Link>
        </div>
    </div>
</div>
</div>
