...
const Whatsapp = () => {
  return (
    <div>
     ...
     <a href="https://wa.me/+9779813133394">
  
<button
  className="fixed bottom-0 right-5  bg-green-500 text-white w-14 h-14 rounded-full flex justify-center items-center shadow-lg hover:bg-green-600 transition-all duration-300 ease-out group z-50 hover:scale-105 active:scale-95"
