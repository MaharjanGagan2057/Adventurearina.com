      ...
      <section
        ...
        <div className="lg:absolute lg:right-10 flex items-center ml-auto space-x-8">
          ...
          <span className="relative">
            ...
            <span className="absolute left-auto -ml-1 top-0 rounded-full bg-blue-600 px-1 py-0 text-xs min-w-[15px] text-center text-white">4</span>
          </span>
      ...
      <div className="flex flex-wrap justify-center sm:px-10 px-4 py-3 relative ">
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li className="max-lg:border-b max-lg:border-gray-300 max-lg:px-3 max-lg:py-3"><a href='javascript:void(0)'
              className="hover:text-blue-700 text-blue-700 block font-medium text-[15px]">Home</a></li>
            <li className="group max-lg:border-b max-lg:border-gray-300 max-lg:px-3 max-lg:py-3 relative">
              <a href='javascript:void(0)'
                className="hover:text-blue-700 hover:fill-blue-700 text-slate-900 font-medium text-[15px] flex items-center">Store<svg
              ...
              <ul
                className="absolute top-5 max-lg:top-8 left-0 z-50 block space-y-2 shadow-lg bg-white max-h-0 overflow-hidden min-w-[230px] group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-[400ms]">
                <li className="border-b border-gray-300 py-3">
                  <a href='javascript:void(0)'
                    className="hover:text-blue-700 hover:fill-blue-700 text-slate-900 font-normal text-[15px] flex items-center">
