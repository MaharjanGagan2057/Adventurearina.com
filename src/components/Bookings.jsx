...
const Bookings = () => {
  return (
   ...
   <form action="https://usebasin.com/f/f6ad4d754f60" method="POST" className="space-y-4">
       ...
       <div>
           <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-purple-600 bg-blue-400 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 m-1 ">
               Request Booking
           </button>
       </div>
   </form>
